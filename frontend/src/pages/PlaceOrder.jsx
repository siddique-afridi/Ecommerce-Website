  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          <input className='border border-gray-300 py-1.5 px-3.5 w-full' type="text" placeholder='Zipcode' />
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex flex-col gap-3 lg:flex-row'>
                <div onClick={()=>setMethod('stripe')} className='flex items-center gap-0 border p-2 px-3 cursor-pointer'>
                  <p className={`min-w-3.5 h-3.5 border rounded-full ${method === "stripe" ? 'bg-green-400' : ''}`}></p>
                  <img className='h-5 mx-4' src={assets.stripe_logo} alt="" />
                </div>
                <div onClick={()=>setMethod('razorpay')} className='flex items-center gap-0 border p-2 px-3 cursor-pointer'>
                  <p className={`min-w-3.5 h-3.5 border rounded-full ${method === "razorpay" ? 'bg-green-400' : ''}`}></p>
                  <img className='h-5 mx-4' src={assets.razorpay_logo} alt="" />
                </div>
                <div onClick={()=>setMethod('cod')} className='flex items-center gap-0 border p-2 px-3 cursor-pointer'>
          ...
          <div className='w-full text-end mt-8'>
            <button onClick={()=>navigate('/orders')} className='text-white  bg-orange-500 text-sm py-3 px-16 active:bg-gray-700 hover:bg-orange-600 hover:rounded-lg transition-all'>PLACE ORDER</button>
          </div>
        </div>
